	...
	<ui:dataview id="training">
		...
		<ui:render type="Template">
			...
			{$
				<c:if test="${!param.isPrint}">
				<tr>
					<td colspan="6" class="add_td" onclick="addOrEdit('training');" title="${ lfn:message('button.add') }"> <span class="lui_icon_s icon_opt_add"></span><span>${ lfn:message('button.add') }</span></td>
				</tr>
				</c:if>
			</table>
			$}
