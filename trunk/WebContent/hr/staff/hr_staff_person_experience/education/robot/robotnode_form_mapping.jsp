...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdSchoolName","fdBeginDate","fdEndDate","fdMajor","fdDegree","fdMemo");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdSchoolName");
				createSelectElementHTML("fdMajor");
				createSelectElementHTML("fdDegree");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				<tr align="center">
					<td width="20%">
						${lfn:message('hr-staff:hrStaff.robot.educationAttribute') }
					</td>
					<td width="30%">
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaff.robot.educationPerson') }
					</td>
					<td id="fdApplicant">
					</td>
					<td>
