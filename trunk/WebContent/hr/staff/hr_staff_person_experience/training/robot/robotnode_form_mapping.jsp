...
// 			    var _s = new Array("fdApplicant","fdLeaveDays","fdBeginDate","fdEndDate","fdLeaveType");
			    var _s = new Array("fdApplicant","fdTrainingName","fdBeginDate","fdEndDate","fdMemo","fdTrainingUnit");
			...
			LUI.ready(function(){
				...
				createSelectElementHTML("fdTrainingName");
				createSelectElementHTML("fdBeginDate");
				createSelectElementHTML("fdEndDate");
				createSelectElementHTML("fdTrainingUnit");
		...
		<center>
			...
			<table width="100%" class="tb_normal">
				<tr align="center">
					<td width="20%">
						${lfn:message('hr-staff:hrStaff.robot.trainingAttribute') }
					</td>
					<td width="30%">
				...
				<tr align="center">
					<td>
						${lfn:message('hr-staff:hrStaff.robot.trainingPerson') }
					</td>
					<td id="fdApplicant">
					</td>
					<td>
