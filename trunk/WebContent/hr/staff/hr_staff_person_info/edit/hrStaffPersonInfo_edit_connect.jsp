				...
				<table class="staffInfo newTable" >
						...
						<tr>
							...
							<td width="35%" class="inputwidth">
								<xform:text property="fdMobileNo" showStatus="edit" validators="phone uniqueMobileNo required" style="width:98%;" className="inputsgl" 
							...
							<td width="35%" class="inputwidth">
								<xform:text property="fdEmail" showStatus="edit" validators="email"  className="inputsgl" />
							</td>
						</tr>
						<tr>
							<!-- 办公地点 -->
							...
							<td width="35%" class="inputwidth">
								<xform:text showStatus="edit" property="fdOfficeLocation"  className="inputsgl" />
							</td>
							<!-- 办公电话 -->
							<td width="15%" class="td_normal_title">
							...
							<td width="35%" class="inputwidth">
								<xform:text property="fdWorkPhone" showStatus="edit" style="width:98%;" className="inputsgl" 
						...
						<tr>
							...
							<td width="35%" class="inputwidth">
								<xform:text showStatus="edit" property="fdEmergencyContact"  className="inputsgl" />
							</td>
							...
							<td width="35%" class="inputwidth">
								<xform:text showStatus="edit" property="fdEmergencyContactPhone"  className="inputsgl" validators="phone"/>
							</td>
						...
						<tr>
							...
							<td width="35%" class="inputwidth">
								<xform:text showStatus="edit" property="fdOtherContact" style="width:98%;" className="inputsgl" />
							</td>
						</tr>
					<%-- 引入动态属性 --%>
