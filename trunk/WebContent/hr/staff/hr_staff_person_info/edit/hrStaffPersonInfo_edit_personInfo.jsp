...
<%-- 					<tr>
					...
					<tr>
						...
						<td width="35%" class="datawidth">
							<xform:datetime showStatus="edit"  property="fdDateOfGroup" dateTimeType="date" validators="compareTime(group)"></xform:datetime>
						</td>
						<!-- 入党日期 -->
						<td width="15%" class="td_normal_title">
						...
						<td width="35%" class="datawidth">
							<xform:datetime showStatus="edit"  property="fdDateOfParty" dateTimeType="date" validators="compareTime(group)"></xform:datetime>
						</td>
					</tr>
					<tr>
						<!-- 最高学历 -->
					...
					<tr>
						...
						<td width="35%" class="inputwidth">
							<xform:text showStatus="edit"  property="fdStature" style="width:98%;" validators="digits min(1)" className="inputsgl" />
						</td>
						<!-- 体重（千克） -->
						<td width="15%" class="td_normal_title">
						...
						<td width="35%" class="inputwidth">
							<xform:text showStatus="edit"  property="fdWeight" style="width:98%;" validators="digits min(1)" className="inputsgl" />
						</td>
					</tr>
					<tr>
						<!-- 现居地 -->
						...
						<td width="35%" class="inputwidth">
							<xform:text showStatus="edit"  property="fdLivingPlace" style="width:98%;" className="inputsgl" />
						</td>
						<!-- 籍贯 -->
						<td width="15%" class="td_normal_title">
					...
					<tr>
						...
						<td width="35%" class="inputwidth">
							<xform:text showStatus="edit"  property="fdHomeplace" style="width:98%;" className="inputsgl" />
						</td>
						<!-- 户口性质 -->
						<td width="15%" class="td_normal_title">
					...
					<tr>
						...
						<td width="35%" class="inputwidth">
							<xform:text showStatus="edit"  property="fdResidencePoliceStation" style="width:98%;" className="inputsgl" />
						</td>
					</tr>
					<tr>
						...
						<td width="35%" class="datawidth">
							<xform:datetime required="true" showStatus="edit" property="fdTimeOfEnterprise" dateTimeType="date" validators="timeOfEnterprise" onValueChange="timeOfEnterpriseChange"></xform:datetime>
						</td>
						<!-- 本企业工龄 -->
<%-- 						<td width="15%" class="td_normal_title">本企业工龄</td>
						<td width="35%">
							<xform:text  showStatus="edit" property="fdWorkingYears"></xform:text>
						</td> --%>
					</tr>
					<tr>
						<!-- 本企业工龄 -->
