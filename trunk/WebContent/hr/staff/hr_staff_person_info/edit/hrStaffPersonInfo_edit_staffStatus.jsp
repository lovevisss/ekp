				...
				<table class="staffInfo newTable" >
					<tr>
						...
						<td width="35%" class="inputwidth">
							...
							<xform:select property="fdStatus" className="hr_select" showStatus="edit" onValueChange="changeStatus">
					...
					<tr>
						<td width="15%" class="td_normal_title">
							${ lfn:message('hr-staff:hrStaffPersonInfo.fdNatureWork') }
						</td>
						<td width="35%" class="inputwidth">
					...
					<tr>
						...
						<td width="35%" class="datawidth">
							<xform:datetime showStatus="edit" property="fdPositiveTime" dateTimeType="date" validators="compareTime(entry)"></xform:datetime>
						</td>
