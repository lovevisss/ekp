				...
				<script type="text/javascript">
					seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($, dialog , topic) {
						...
						window.exportPerson = function(){
							dialog.iframe('/hr/staff/hr_staff_person_info/hrStaffPersonInfo_exportPerson.jsp','<bean:message bundle="hr-staff" key="hr.staff.btn.export" />',null,{width:600,height:250});
						};
