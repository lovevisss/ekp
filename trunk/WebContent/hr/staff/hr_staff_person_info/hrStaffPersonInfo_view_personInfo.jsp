...
<ui:content expand="true" title="${ lfn:message('hr-staff:table.HrStaffPersonInfo') }">
	<table class="staff_resume_simple_tb">
		...
		<tr>
			...
			<td width="35%">
				${ hrStaffPersonInfoForm.fdTrialOperationPeriod }
			</td>
		</tr>
		<tr>
			<td width="15%" class="td_normal_title">
			...
			<td width="35%">
				${ hrStaffPersonInfoForm.fdEntryTime }
			</td>
			<td width="15%" class="td_normal_title">
				<bean:message bundle="hr-staff" key="hrStaffPersonInfo.fdPositiveTime" />
			</td>
			<td width="35%">
				${ hrStaffPersonInfoForm.fdPositiveTime }
			</td>
		</tr>
		<tr>
			<td width="15%" class="td_normal_title">
		...
		<c:if test="${hrStaffPersonInfoForm.fdIsRehire eq 'true' }">
			<tr>
				<td width="15%" class="td_normal_title">
					<bean:message bundle="hr-staff" key="hrStaffPersonInfo.fdRehireTime" />
				</td>
				<td colspan="3">
					${ hrStaffPersonInfoForm.fdRehireTime }
				</td>
			</tr>
		</c:if>
		<%-- 引入动态属性 --%>
