      ...
      <c:choose>
       ...
       <table>
         <tbody>
             ...
             <tr><td><bean:message key="hrStaffPersonInfo.fdDateOfGroup" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdDateOfGroup}</td><td><bean:message key="hrStaffPersonInfo.fdDateOfParty" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdDateOfParty}</td></tr>
             <tr><td><bean:message key="hrStaffPersonInfo.fdHighestEducation" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdHighestEducation}</td><td><bean:message key="hrStaffPersonInfo.fdHighestDegree" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdHighestDegree}</td></tr>
             <tr><td><bean:message key="hrStaffPersonInfo.fdMaritalStatus" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdMaritalStatus}</td><td  ><bean:message key="hrStaffPersonInfo.fdHealth" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdHealth}</td></tr>
             <tr><td><bean:message key="hrStaffPersonInfo.fdStature" bundle="hr-staff"/></td><td>${hrStaffPersonInfoForm.fdStature}</td><td><bean:message key="hrStaffPersonInfo.fdWeight" bundle="hr-staff"/></td><td>${hrStaffPersonInfoForm.fdWeight}</td></tr>
             <tr><td><bean:message key="hrStaffPersonInfo.fdLivingPlace" bundle="hr-staff"/></td><td> <span title="${hrStaffPersonInfoForm.fdLivingPlace}">${hrStaffPersonInfoForm.fdLivingPlace}</span></td><td><bean:message key="hrStaffPersonInfo.fdNativePlace" bundle="hr-staff"/></td><td  > <span title="${hrStaffPersonInfoForm.fdNativePlace}">${hrStaffPersonInfoForm.fdNativePlace}</span></td></tr>
             <tr>
             	<td>
             		<bean:message key="hrStaffPersonInfo.fdHomeplace" bundle="hr-staff"/>
             	</td>
             	<td><span title="${hrStaffPersonInfoForm.fdHomeplace}">${hrStaffPersonInfoForm.fdHomeplace}</span></td>
             ...
             <tr><td><bean:message key="hrStaffPersonInfo.fdRegisteredResidence" bundle="hr-staff"/></td><td  ><span title="${hrStaffPersonInfoForm.fdRegisteredResidence}">${hrStaffPersonInfoForm.fdRegisteredResidence}</span></td><td  ><bean:message key="hrStaffPersonInfo.fdResidencePoliceStation" bundle="hr-staff"/></td><td  ><span title="${hrStaffPersonInfoForm.fdResidencePoliceStation}">${hrStaffPersonInfoForm.fdResidencePoliceStation}</span></td></tr>
             <tr><td><bean:message key="hrStaffPersonInfo.fdTimeOfEnterprise" bundle="hr-staff"/></td><td>${hrStaffPersonInfoForm.fdTimeOfEnterprise}</td><td><bean:message key="hrStaffPersonInfo.fdWorkTime" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdWorkTime}</td></tr>
             <tr><td  ><bean:message key="hrStaffPersonInfo.fdWorkingYears" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdWorkingYears}</td><td><bean:message key="hrStaffPersonInfo.fdUninterruptedWorkTime" bundle="hr-staff"/></td><td  >${hrStaffPersonInfoForm.fdUninterruptedWorkTime}</td></tr>
