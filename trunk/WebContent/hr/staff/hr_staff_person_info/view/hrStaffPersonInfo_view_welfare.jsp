...
<div class="lui-personnel-file-staffInfo" id="salaryAdjustRecord">
    ...
    <div class="salaryAdjustRecord">
        <div class="salaryAdjustRecord-text">${ lfn:message('hr-staff:table.hrStaffEmolumentWelfareDetalied') }</div>
        <div class="salaryAdjustRecord-action">
            <span class="salaryAdjustRecord-action-icon"></span>
            <span class="salaryAdjustRecord-action-text">${ lfn:message('hr-staff:hrStaffEmolumentWelfareDetalied.folder') }</span>
        </div>
    </div>
