<%-- {"login_logo_position":"logoPositionOnLogoShow","single_logo":"single_logo.png","single_login_bg":"img_login.jpg","loginBtn_font_color":"#fff","login_form_align":"loginFormOnRight","title_image":"favicon.ico","login_title_show":"loginTitleShow","single_im_icon":"icon_KK.png","single_kms_icon":"icon_KMS.png","single_ekp_icon":"icon_EKP.png","single_footerInfo_CN":"蓝凌软件 版权所有","single_logo_text_CN":"知识管理与协同领导品牌","login_form_title_CN":"登录系统","loginBtn_text_CN":"登录","title_CN":"登录系统test","single_im_CN":"企业移动社交平台","single_kms_CN":"KMS知识管理平台","single_ekp_CN":"EKP协同办公平台","isLoginTitleActive":false} --%>
...
<%
	...
	loginConfig.put("title_CN", "登录系统test");
