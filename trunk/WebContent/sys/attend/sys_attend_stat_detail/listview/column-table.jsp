			...
			<div class="lui_listview_centerC">
				<table width="100%" class="lui_listview_columntable_table">
					<thead data-lui-mark="column.table.header">$}
						...
						var workTime1 = "fdSignTime;docStatus;fdState;fdSignTime2;docStatus2;fdState2;";
							...
							if('true' != col.hide){
								...
								if(tdspan.length>0){
									...
									if(prop && _isContain(workTime2,prop) && !workTimeTxt2){
										workTimeTxt2 = true;
										{$<th colspan=6><bean:message bundle="sys-attend" key="sysAttendStatDetail.workTime.second"/></th>$}
									}
