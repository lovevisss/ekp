...
function checkValue() {
	...
	var detailName2 = fdOvtDate['value'].indexOf('.')>-1 ? fdOvtDate['value'].split('.')[0] : undefined;
...
$(function(){
	...
	createSelectHTML('#ovtDateTd', 'fdOvtDate', 'Date;Date[]');
	createSelectHTML('#startTimeTd', 'fdOvtStartTime', 'Time;Time[]');
	createSelectHTML('#endTimeTd', 'fdOvtEndTime', 'Time;Time[]');
});
...
<table id="List_ViewTable" class="tb_normal" width="98%">
	...
	<tr height="21">
		<td class="td_normal_title" width="20%">
			<bean:message bundle="sys-attend" key="sysAttend.event.overtime.date" />
		</td>
		<td id='ovtDateTd'>
