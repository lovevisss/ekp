...
<c:if test="${_status =='20' }">
	<span class="kmImeetingStatusExamine">
...
<c:if test="${_status=='30' && isBegin==false }">
	<span class="kmImeetingStatusUnhold">
...
<c:if test="${_status=='30' && isBegin==true && isEnd==false }">
	<span class="kmImeetingStatusHolding">
...
<c:if test="${_status=='30' && isEnd==true }">
	<span class="kmImeetingStatusHolded">
...
<c:if test="${_status=='41' }">
	<span class="kmImeetingStatusCancel">
