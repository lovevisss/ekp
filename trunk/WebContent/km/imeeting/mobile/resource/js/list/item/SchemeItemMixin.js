define([
    ...
    "dojox/mobile/_ItemBase",
   	...
   	"mui/i18n/i18n!km-imeeting:date"
			...
			locale,msg) {
	var item = declare("mui.list.item.SummaryCardItemMixin", [ItemBase, openProxyMixin], {
		...
		buildInternalRender : function() {
			...
			domConstruct.create("p", {className: "meeting_cardList_subject",innerHTML:this.docSubject}, headNode);
			...
			domConstruct.create("span", {className: "meeting_cardList_author",innerHTML:this.fdHost}, footerRNode);
