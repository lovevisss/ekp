								...
								<td class="muiTitle">
									<c:choose>
										...
										<c:otherwise>
											<div id="placeComponent"
												data-dojo-type="km/imeeting/mobile/resource/js/PlaceComponent"
												data-dojo-props='"subject":"${lfn:message("km-imeeting:kmImeetingMain.fdPlace") }","idField":"fdPlaceId","nameField":"fdPlaceName","showStatus":"edit","curIds":"${kmImeetingMainForm.fdPlaceId}","curNames":"${kmImeetingMainForm.fdPlaceName}","validate":"validateUserTime",orient:"vertical",required:"false"'></div>
											<%-- <xform:text property="fdOtherPlace" mobile="true"  />	 --%>
											<input type="hidden" name="fdPlaceUserTime" value="${ kmImeetingMainForm.fdUserTime}"
