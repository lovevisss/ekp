                    ...
                    <tr data-celltr="true">
                        ...
                        <td>
							<span class="td_subject">
								<%-- 不可思议但无可奈何，移动端明细表的基准行不能直接用input去包!{index}的属性，不然删除最后一个会报错  --%>
<%--								<input type='hidden' name='kmImeetingAgendaForms[!{index}].docSubject' />--%>
								<xform:text property="kmImeetingAgendaForms[!{index}].docSubject"
                                            mobile="true" showStatus="noShow"/>
							</span>
                            <%--							<input type='hidden' name='kmImeetingAgendaForms[!{index}].fdSchemeId' value='${kmImeetingSchemeForm.fdId}'/>--%>
                            <xform:text property="kmImeetingAgendaForms[!{index}].fdSchemeId"
                                        mobile="true" showStatus="noShow"/>
                        </td>
                    </tr>
                    <!-- 承办单位 -->
                    <tr data-celltr="true">
                        ...
                        <td>
							<span class="td_chargeUnit">
								<xform:text property="kmImeetingAgendaForms[!{index}].fdChargeUnitId"
                                            mobile="true" showStatus="noShow"/>
                    ...
                    <tr data-celltr="true">
                        ...
                        <td>
							<span class="td_reporter">
								<xform:text property="kmImeetingAgendaForms[!{index}].docReporterId"
                                            mobile="true" showStatus="noShow"/>
<%--								<input type='hidden' name='kmImeetingAgendaForms[!{index}].docReporterId'/>--%>
                    ...
                    <tr style="display: none;">
                        ...
                        <td>
                            <span class="td_docRespons">
								<xform:text property="kmImeetingAgendaForms[!{index}].docResponsId"
                                            mobile="true" showStatus="noShow"/>
							</span>
                            <span class="td_docResponsN">
								<xform:text property="kmImeetingAgendaForms[!{index}].docResponsName"
                                            mobile="true" showStatus="noShow"/>
							</span>
                        </td>
                    </tr>
                    ...
                    <tr data-celltr="true">
                        ...
                        <td>
							<span class="td_attendUnit">
								<xform:text property="kmImeetingAgendaForms[!{index}].fdAttendUnitIds"
                                            mobile="true" showStatus="noShow"/>
                    ...
                    <tr data-celltr="true">
                        ...
                        <td>
							<span class="td_listenUnit">
								<xform:text property="kmImeetingAgendaForms[!{index}].fdListenUnitIds"
                                            mobile="true" showStatus="noShow"/>
                    ...
                    <tr data-celltr="true">
                        ...
                        <td>
							<span class="td_fromTopic">
								<xform:text property="kmImeetingAgendaForms[!{index}].fdFromTopicId" showStatus="noShow"
                                            mobile="true" htmlElementProperties="class='muiTopicId'"/>
                    ...
                    <tr style="display: none;">
                        <td>
							<span class="td_topicCreator">
								<xform:text property="kmImeetingAgendaForms[!{index}].topicCreatorId"
                                            mobile="true" showStatus="noShow"/>
<%--								<input type="hidden" name="kmImeetingAgendaForms[!{index}].topicCreatorId">--%>
							</span>
                            <span class="td_topicCreatorN">
								<xform:text property="kmImeetingAgendaForms[!{index}].topicCreatorName"
                                            mobile="true" showStatus="noShow"/>
<%--								<input type="hidden" name="kmImeetingAgendaForms[!{index}].topicCreatorName">--%>
                ...
                <td class="detail_wrap_td">
                    <table class="muiSimple">
                        ...
                        <tr data-celltr="true">
                            ...
                            <td>
								<c:out value="${kmImeetingAgendaitem.docSubject}"/>
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].fdId" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.fdId}"/>
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].fdSchemeId" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.fdSchemeId}"/>
                                <xform:text property="kmImeetingAgendaForms[${vstatus.index}].topicCreatorId" showStatus="noShow"
                                            mobile="true" value="${kmImeetingAgendaitem.topicCreatorId}"/>
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].fdFromTopicId" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.fdFromTopicId}" htmlElementProperties="class='muiTopicId'"/>
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].docSubject" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.docSubject}"/>
                            </td>
                        </tr>
                        <!-- 承办单位 -->
                        <tr>
                            ...
                            <td>
								<c:out value="${kmImeetingAgendaitem.fdChargeUnitName}"/>
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].fdChargeUnitId" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.fdChargeUnitId}"/>
                            </td>
                        </tr>
                        <!-- 汇报人 -->
                        <tr data-celltr="true">
                            ...
                            <td>
								...
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].docReporterId" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.docReporterId}"/>
                            </td>
                        </tr>
                        <!-- 材料负责人 -->
                        <tr style="display: none;">
                            ...
                            <td>
								...
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].docResponsId" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.docResponsId}"/>
                            </td>
                        </tr>
                        <!-- 建议列席单位 -->
                        <tr data-celltr="true">
                            ...
                            <td>
								...
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].fdAttendUnitIds" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.fdAttendUnitIds}"/>
                            </td>
                        </tr>
                        <!-- 建议旁听单位 -->
                        <tr data-celltr="true">
                            ...
                            <td>
								...
								<xform:text property="kmImeetingAgendaForms[${vstatus.index}].fdListenUnitIds" showStatus="noShow"
											mobile="true" value="${kmImeetingAgendaitem.fdListenUnitIds}"/>
                            </td>
                        </tr>
                        <!-- 上会所需材料 -->
                        <tr data-celltr="true">
                        ...
                        <tr style="display: none;">
                            <td>
                                ...
                                <span class="td_topicCreatorN">
									<xform:text property="kmImeetingAgendaForms[${vstatus.index}].topicCreatorName" showStatus="noShow"
												mobile="true" value="${kmImeetingAgendaitem.topicCreatorName}"/>
								</span>
                            </td>
                        </tr>
                    </table>
    ...
    <c:if test="${showBtn eq 'true'}">
        <div
            ...
            <span class="muiImeetingSIFont"><c:out value="请选择"></c:out></span>
    ...
    require(['dojo/ready', 'dijit/registry', 'dojo/topic', 'dojo/request',
        ...
        function (ready, registry, topic, request, dom, domAttr, domStyle, domClass, query, Tip, parser, pageLoading) {
                                ...
                                if (topicListIds.indexOf(results[i].fdTopicId, 0) == -1) {
                                    ...
                                    parser.parse(newRow).then(function () {
                                        ...
                                        if (results[i].fdMaterialStaffId) {
                                            $(newRow).find(".td_docRespons input").val(results[i].fdMaterialStaffId);
                                            $(newRow).find(".td_docResponsN").append(results[i].fdMaterialStaffName);
                                        }
            ...
            window.deleteRow = function (domNode) {
                var trDom = null;
                var detailWrapTdObj = query(domNode).parents('.detail_wrap_td');
                if (detailWrapTdObj.length > 0) {
                    trDom = detailWrapTdObj.parent()[0];
                }
                if (trDom == null) {
                    return
                }
                ...
                let queryName = 'input[name="kmImeetingAgendaForms[' + rowIndex + '].fdFromTopicId"]'
                var topicId = query(queryName, detailWrapTdObj[0])[0].value;
                if (topicId != null && topicId.length > 0) {
                    topicListIds = topicListIds.replace(topicId, "");
                }
                query('*[widgetid]', trDom).forEach(function (widgetDom) {
                            ...
                            for (var j = 0; j < updateAttrs.length; j++) {
                                if (widget[updateAttrs[j]]) {
                                    ...
                                    if (updatFileds.length > 0) {
                                        updatFileds[0].name = detail_replaceIndexInfo(updatFileds[0].name, i - tbInfo.firstIndex);
                                    }
                                    widget[updateAttrs[j]] = detail_replaceIndexInfo(widget[updateAttrs[j]], i - tbInfo.firstIndex);
                                }
                            }
                        } else if (widget.name) {
                            var tmpFileds = query("[name='" + widget.name + "']", row);
                            if (tmpFileds.length > 0) {
                                tmpFileds[0].name = detail_replaceIndexInfo(tmpFileds[0].name, i - tbInfo.firstIndex);
                            }
                            widget.name = detail_replaceIndexInfo(widget.name, i - tbInfo.firstIndex);
                        } else if (widget.idField) {
                            var tmpIdField = query("[name='" + widget.idField + "']", row);
                            if (tmpIdField.length > 0) {
                                tmpIdField[0].name = detail_replaceIndexInfo(tmpIdField[0].name, i - tbInfo.firstIndex);
                            }
                            var tmpNameField = query("[name='" + widget.nameField + "']", row);
                            if (tmpNameField.length > 0) {
                                tmpNameField[0].name = detail_replaceIndexInfo(tmpNameField[0].name, i - tbInfo.firstIndex);
                            }
							widget.idField = detail_replaceIndexInfo(widget.idField, i - tbInfo.firstIndex);
							widget.nameField = detail_replaceIndexInfo(widget.nameField, i - tbInfo.firstIndex);
							if (widget.key) {
								//#145018 云开发平台移动端明细表删除行后选择框出错问题
								widget.key = detail_replaceIndexInfo(widget.key, i - tbInfo.firstIndex);
							}
                        }
                    });
                }
            ...
            function detail_replaceIndexInfo (fieldName, index) {
