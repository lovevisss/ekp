...
<template:include ref="mobile.list">
	...
	<template:replace name="content">
		...
		<c:choose>
			<c:when test="${kmImeetingBookForm.fdExamerId eq KMSS_Parameter_CurrentUserId && 
					...
					<ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom" 
						data-dojo-props='fill:"always"'>
					  	...
					  	<kmss:authShow roles="ROLE_KMIMEETING_CREATE">
					  		...
					  		<c:if test="${ empty kmImeetingBookForm.fdRecurrenceStr}">
					  		<li data-dojo-type="km/imeeting/mobile/resource/js/CreateButton"
									data-dojo-mixins="mui/syscategory/SysCategoryMixin" 
							   		data-dojo-props="
							   			createUrl:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=add&fdTemplateId=!{curIds}&bookId=${kmImeetingBookForm.fdId}&_referer=${LUI_ContextPath}/km/imeeting/mobile/index.jsp',
							   			...
							   			authType: '02',
							   			key: 'normalMeeting',icon1:''">
								<bean:message key="kmImeetingBook.changeToImeeting" bundle="km-imeeting"/>
							</li>
							</c:if>
							</c:if>
						</kmss:authShow>
						...
						<kmss:auth requestURL="/km/imeeting/km_imeeting_book/kmImeetingBook.do?method=edit&fdId=${kmImeetingBookForm.fdId}" requestMethod="GET">
					  	...
					  	<kmss:authShow roles="ROLE_KMIMEETING_CREATE">
					  		...
					  		<li data-dojo-type="km/imeeting/mobile/resource/js/CreateButton"
									data-dojo-mixins="mui/syscategory/SysCategoryMixin" 
							   		data-dojo-props="
							   			createUrl:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=add&fdTemplateId=!{curIds}&bookId=${kmImeetingBookForm.fdId}',
							   			mainModelName:'com.landray.kmss.km.imeeting.model.KmImeetingMain',
							   			modelName:'com.landray.kmss.km.imeeting.model.KmImeetingTemplate',
							   			showFavoriteCate:'true',
							   			authType: '02',
		...
		<script>
			...
			require(['dojo/dom', 'dojo/dom-construct', 'dojo/on', 'dojo/request', 'mui/dialog/Confirm', 'mui/dialog/Tip','mui/dialog/Dialog',"dojo/_base/lang",'dojo/query'], 
					function(dom, domCtr, on, request, Confirm, Tip, Dialog, lang, query) {
