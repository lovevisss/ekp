...
<list:data>
	<list:data-columns var="kmImeetingTopic" list="${queryPage.list }">
		...
		<list:data-column headerStyle="width:120px"  property="docNumber" title="${ lfn:message('km-imeeting:kmImeetingTopic.fdNo')}"/>
		<%--名称--%>
		...
		<list:data-column  headerClass="width80" col="fdReporter.fdName" title="${ lfn:message('km-imeeting:kmImeetingTopic.fdReporter')}" escape="false">
			<ui:person personId="${kmImeetingTopic.fdReporter.fdId}" personName="${kmImeetingTopic.fdReporter.fdName}"/>
		</list:data-column>
