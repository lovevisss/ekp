...
<c:choose>
	<c:when test="${lbpmApproveModel eq 'right'}">
		<template:include ref="lbpm.right" showQrcode="true" fdUseForm="${kmImeetingTopicForm.docUseXform == 'true' || empty kmImeetingTopicForm.docUseXform}" formName="kmImeetingTopicForm" formUrl="${KMSS_Parameter_ContextPath}km/imeeting/km_imeeting_topic/kmImeetingTopic.do">
