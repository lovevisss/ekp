    ...
    <template:replace name="body">
                ...
                <div style="display: inline-block;vertical-align: middle;">
                    <ui:toolbar count="5" id="Btntoolbar">
                        ...
                        <kmss:auth requestURL="/km/imeeting/km_imeeting_topic/kmImeetingTopic.do?method=deleteall">
                            <ui:button id="del" text="${lfn:message('button.deleteall')}" order="3" onclick="delDoc();"/>
                        </kmss:auth>
                    </ui:toolbar>
                </div>
            </div>
        ...
        <list:listview id="listview_topic">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_topic/kmImeetingTopic.do?method=list&q.j_path=%2Fdiscard%2FtopicDiscard&q.docStatus=00'}
            </ui:source>
            <list:colTable
