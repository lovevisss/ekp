...
<template:include ref="default.simple" rwd="true">
	<template:replace name="body">
		...
		<div>
		<ui:tabpanel layout="sys.ui.tabpanel.list" cfg-router="true" var-average = 'false'>
			<ui:content title="议题申报">
			...
			<ui:content title="我起草的">
				<ui:iframe  src="${LUI_ContextPath }/km/imeeting/km_imeeting_topic/index_myDraft.jsp"></ui:iframe>
			</ui:content>
