...
<template:include ref="default.print" sidebar="no">
	...
	<template:replace name="content">
		...
		<form name="kmImeetingTopicFormTemp" method="post" action="<c:url value="/km/imeeting/km_imeeting_topic/kmImeetingTopic.do" />">
		<center>
		...
		<center id="print_content">
			<c:forEach items="${kmImeetingTopicFormList }" var="kmImeetingTopicFormTemp" varStatus="vstatus">
				<kmss:auth requestURL="/km/imeeting/km_imeeting_topic/kmImeetingTopic.do?method=view&fdId=${kmImeetingTopicFormTemp.fdId}" requestMethod="GET">
					<c:set var="kmImeetingTopicForm" value="${kmImeetingTopicFormTemp }" scope="request" />
					<div class="print_title_header">
						<p id="title" class="print_txttitle">
							<bean:write name="kmImeetingTopicForm" property="docSubject" />
						</p>
						<div class="printDate">
									...
									<tr>
										<td name="_xform_detail">
											...
											<c:import url="/sys/xform/include/sysForm_view.jsp" charEncoding="UTF-8">
												...
												<c:param name="fdId" value="${kmImeetingTopicForm.fdId }" />
					...
					<% 
						...
						// 清除表单信息
						request.removeAttribute("kmImeetingTopicForm"); 
					%>
				</kmss:auth>
			</c:forEach>
		</center>
