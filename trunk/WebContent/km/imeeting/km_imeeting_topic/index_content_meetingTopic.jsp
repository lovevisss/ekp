...
<template:include ref="default.simple" spa="true">
	<template:replace name="body">
	  ...
	  <list:criteria id="sendCriteria">
			...
			<list:cri-ref ref="criterion.sys.category" key="fdTopicCategory" multi="false" title="${ lfn:message('km-imeeting:kmImeetingTopic.fdTopicCategory') }" expand="false">
		...
		seajs.use(['lui/jquery', 'lui/util/str', 'lui/dialog','lui/topic','lui/toolbar'], function($, strutil, dialog , topic ,toolbar) {
			...
			window.addDoc = function() {
				 dialog.categoryForNewFile(
						 ...
						 '/km/imeeting/km_imeeting_topic/kmImeetingTopic.do?method=add&fdTemplateId=!{id}',false,null,null,cateId,null,null,true); 
	 		};
			//删除回调	
