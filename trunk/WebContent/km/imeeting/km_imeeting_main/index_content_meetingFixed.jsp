    ...
    <template:replace name="body">
        ...
        <list:criteria id="imeetingCriteria" cfg-canExpand="false">
            <list:tab-criterion title="" key="meetingStatus">
                <list:box-select>
                    <list:item-select id="status_for_imeeting" cfg-enable="true"
                    ...
                    <ui:toolbar count="7" id="Btntoolbar">
                        ...
                        <kmss:authShow roles="ROLE_KMIMEETING_CREATE">
                            ...
                            <ui:button title="${lfn:message('km-imeeting:table.kmImeetingVideo') }"
                                       ...
                                       onclick="window.open('${LUI_ContextPath }/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=add&noTemplate=true')"
                                       order="2">
                            </ui:button>
                            <%} %>
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=listChildren&categoryId=${JsParam.categoryId}&nodeType=${JsParam.nodeType}&except=${JsParam.except}&isCycle=false&q.j_path=%2FmainView&q.docType=all'}
            </ui:source>
            <list:colTable
