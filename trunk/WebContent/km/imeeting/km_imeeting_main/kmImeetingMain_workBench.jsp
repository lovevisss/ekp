                                                    ...
                                                    <div class="lui_meeting_panel_wrap">
                                                        <div class="lui_meeting_panel_content">
                                                            <div class="lui_mpms_wrap">
                                                                ...
                                                                <div class="lui_mpms_num">{%data.count%}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </div>$}
                                                    ...
                                                    <div class="lui_meeting_panel_content">
                                                        <div>
                                                            ...
                                                            <ul class="lui_mpmi_content">
                                                                ...
                                                                <li>
                                                                    <div class="lui_mpmi_content_item">
                                                                        <p class="lui_mpmi_content_item_desc"><bean:message bundle="km-imeeting" key="kmImeeting.Attendees.my"/></p>
                                                                        <ui:dataview>
                                                                            <ui:source type="AjaxJson">
                                        ...
                                        <div class="lui_meeting_panel_multiple_item">
                                            <div class="lui_meeting_panel_sepration">
                                                <div class="lui_meeting_panel_wrap">
                                                    ...
                                                    <div class="lui_meeting_panel_content" style="padding:0 2px;">
                                                        <div>
                                                            <ui:chart var-themeName="shine" var-noRecordStyle="simple" id="main_chart_part" width="330" height="300">
                                                                <ui:source type="AjaxJson">
                                        ...
                                        <div class="lui_meeting_panel_multiple_item">
                                            <div class="lui_meeting_panel_sepration">
                                                <div class="lui_meeting_panel_wrap">
                                                    ...
                                                    <div class="lui_meeting_panel_content" style="padding:0 2px;">
                                                        <div>
                                                            <ui:chart var-themeName="shine" var-noRecordStyle="simple" id="main_chart_cate" width="330" height="300">
                                                                <ui:source type="AjaxJson">
        ...
        <script>
            ...
            function resizeMainChart() {
                if(!isResized) {
                    ...
                    var canHeight = can.height() + Math.abs(h);
                    var style = {
                        "width": width,
                        "height": Math.min(Math.max(canHeight, 258), 500)
                    };
