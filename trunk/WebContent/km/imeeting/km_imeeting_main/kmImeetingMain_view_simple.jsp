				...
				<c:if test="${empty param.type && not empty optType && optType=='01' }">
					<div style="color: red;text-align: center;">
						...
						<a  style="color: red;text-decoration: underline" 
								href="${LUI_ContextPath }/km/imeeting/km_imeeting_main_feedback/kmImeetingMainFeedback.do?method=edit&type=attend&meetingId=${kmImeetingMainForm.fdId }"  target="_blank">
				...
				<c:if test="${ empty param.type && emccFlag == true && emccOpt == 'UnEmccDone' && kmImeetingMainForm.docStatus ne '41' }">
					<div class="lui_metting_notice_container">
						...
						<a class="lui_form_button" style=text-decoration: none" 
                            href="${LUI_ContextPath }/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=editEmcee&type=admin&fdId=${kmImeetingMainForm.fdId }"  target="_blank">
