		...
		<div class="lui_form_content_frame" style="padding-top:20px"> 
			 <table class="tb_normal" width=100% id="Table_Main"> 
				...
				<tr>
			 	...
			 	<c:if test="${ kmImeetingMainForm.fdChangeType eq 'after'}">
					 <c:if test="${kmImeetingConfig.useCyclicity eq '2' || kmImeetingConfig.useCyclicity eq '3' && fn:contains(kmImeetingConfig.useCyclicityPersonId,userId) == true}">
					 	...
					 	<tr>
					 		...
					 		<td width="85%" colspan="3" class="customContainerTD">
								<div>
									<ui:recurrence id="fdRecurrence" property="fdRecurrenceStr" customContainer="#customContainer" isOn="true"></ui:recurrence>
								</div>
			 	...
			 	<tr>
					...
					<td width="85%" colspan="3" >
						<xform:address style="width:97%;height:80px;" textarea="true" required="true" showStatus="edit" propertyName="fdControlPersonName" propertyId="fdControlPersonId" orgType="ORG_TYPE_PERSON" mulSelect="false"  subject="会控人员" ></xform:address>
					</td>
			 	</tr>
			 	<tr>
			 		<%--监票人--%>
					...
					<xform:address  style="width:97%;height:80px;" textarea="true" showStatus="edit"  propertyId="fdBallotPersonIds" propertyName="fdBallotPersonNames" 
							orgType="ORG_TYPE_PERSON" mulSelect="true"  subject="监票人员"></xform:address>
					</td>
			 	</tr>
			 	<%
				 	}
				...
				%>
				 	<tr>
				 		...
				 		<td width="35%" >
							...
							<span id="voteConfig" onclick="voteConfig();">投票配置</span>
						</td>
						<td class="td_normal_title" width=15%>
