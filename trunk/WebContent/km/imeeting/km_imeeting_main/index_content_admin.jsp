...
<template:include ref="default.simple" spa="true">
	<template:replace name="body">
		...
		<list:criteria id="imeetingCriteria" cfg-canExpand="false">
			...
			<list:cri-criterion title="${ lfn:message('km-imeeting:kmImeeting.examine')}" key="docStatus">
				<list:box-select>
				...
				<div style="display: inline-block;vertical-align: middle;">
					...
					<ui:toolbar count="7" id="Btntoolbar">
						...
						<kmss:authShow roles="ROLE_KMIMEETING_PRINT_BATCH">
							<ui:button text="${lfn:message('km-imeeting:kmImeeting.btn.print.batch')}" id="batchPrint" onclick="batchPrint();" order="1" ></ui:button>
						</kmss:authShow>
	...
	<%-- 列表视图 --%>
		<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=listChildren&categoryId=${JsParam.categoryId}&nodeType=${JsParam.nodeType}&except=${JsParam.except}&isCycle=false&q.j_path=%2FmainView'}
			</ui:source>
