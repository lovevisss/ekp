		...
		<div>
			<list:listview id="listview">
				<ui:source type="AjaxJson">
					{url:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=getBoenSignInfo&fdMeetingId=${JsParam.fdId}'}
				</ui:source>
				<list:colTable isDefault="true" layout="sys.ui.listview.columntable" name="columntable">
					<list:col-auto props="userName;orgName;signIn;signTime"></list:col-auto>
				</list:colTable>
