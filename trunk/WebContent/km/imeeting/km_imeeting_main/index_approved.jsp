    ...
    <template:replace name="body">
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_main/kmImeetingMain.do?method=listChildren&categoryId=${JsParam.categoryId}&nodeType=${JsParam.nodeType}&except=${JsParam.except}&isCycle=false&q.j_path=%2FmainApproval%2FmainMyDone&q.docType=myApprovaled'}
            </ui:source>
            <list:colTable
