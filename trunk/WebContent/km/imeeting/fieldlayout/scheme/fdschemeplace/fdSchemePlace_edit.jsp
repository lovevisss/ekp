...
%>
<div id="_fdSchemePlace"  xform_type="xtext">
<xform:xtext property="fdSchemePlace" mobile="${param.mobile eq 'true'? 'true':'false'}" validators="maxLength(200)" required="true" style="<%=parse.getStyle()%>"/>
</div>