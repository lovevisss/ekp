		...
		<list:data-column headerClass="width180" col="operations" title="${ lfn:message('list.operation') }" escape="false">
			...
			<div class="conf_show_more_w">
				<div class="conf_btn_edit">
					...
					<kmss:auth requestURL="/km/imeeting/km_imeeting_res/kmImeetingRes.do?method=delete&fdId=${kmImeetingRes.fdId}" requestMethod="GET">
						<!-- 删除 -->
						<a class="btn_txt" href="javascript:deleteDoc('${kmImeetingRes.fdId}')">${lfn:message('button.delete')}</a>
					</kmss:auth>
					</div>
			</div>
			<!--操作按钮 结束-->
