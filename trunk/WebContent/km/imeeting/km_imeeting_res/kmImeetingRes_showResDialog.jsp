	...
	<template:replace name="content"> 
			...
			<table class="tb_normal" width="98%">
				...
				<tr>
					<%--资源列表--%>
					<td colspan="4">
						<list:listview id="listview" style="overflow-y:scroll;">
				...
				<tr>
					...
					<td colspan="4" style="text-align: center;">
						...
						<%--取消选定--%>
						<ui:button id="select_resource_cancelSelect" text="${lfn:message('button.cancelSelect') }"  onclick="selectCancelSubmit();"/>
					</td>
				</tr>
			</table>
	</template:replace>
