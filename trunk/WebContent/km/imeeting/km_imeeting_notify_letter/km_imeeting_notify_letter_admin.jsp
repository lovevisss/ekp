	...
	<table class="tb_normal" width=100% id="Table_Main">
		<tr>
			<td colspan="4" id="docSubject" style="text-align:center">
				<xform:text property="fdName" style="text-align:center" value="${kmImeetingMainForm.fdName}"></xform:text>
	...
	<div class="lui_form_content_frame">
		<table class="tb_normal" width=100% id="Table_Main"> 
			...
			<tr>
				...
				<td>
					<xform:textarea property="fdSMSContent" style="width:95%" showStatus="view"></xform:textarea>
				</td>
			</tr>
		</table>
	</div>
