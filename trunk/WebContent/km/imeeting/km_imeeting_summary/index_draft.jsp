    ...
    <template:replace name="body">
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_summary/kmImeetingSummary.do?method=listChildren&categoryId=!{categoryId}&nodeType=!{nodeType}&q.docType=myDraft&q.j_path=%2FsummaryDraft&hasDisCard=true'}
            </ui:source>
            <list:colTable
