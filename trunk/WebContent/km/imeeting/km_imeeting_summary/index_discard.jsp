    ...
    <template:replace name="body">
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_summary/kmImeetingSummary.do?method=listChildren&categoryId=!{categoryId}&nodeType=!{nodeType}&q.j_path=%2Fdiscard%2FsummaryDiscard'}
            </ui:source>
            <list:colTable
