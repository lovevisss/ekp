...
<template:include ref="default.simple" spa="true">
    ...
    <template:replace name="body">
        ...
        <list:criteria id="summaryCriteria" cfg-canExpand="false">
            ...
            <list:tab-criterion title="" key="docStatus">
                <list:box-select>
                    <list:item-select cfg-required="${(JsParam.required==null)?'':(JsParam.required)}"
                                      cfg-defaultValue="${(JsParam.defaultValue==null)?'':(JsParam.defaultValue)}"
                                      cfg-enable="true" type="lui/criteria/select_panel!TabCriterionSelectDatas"
                                      cfg-if="(param['mysummary'] == 'myApproved')">
                        <ui:source type="Static">
                            [{text:'${ lfn:message('km-imeeting:kmImeeting.status.refuse')}',value:'11'},
                            {text:'${ lfn:message('km-imeeting:kmImeeting.status.publish') }', value:'30'}]
                        </ui:source>
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_summary/kmImeetingSummary.do?method=listChildren&categoryId=!{categoryId}&nodeType=!{nodeType}&q.docType=myApproved&q.j_path=%2FsummaryApproval%2FsummaryMyDone&hasDisCard=true'}
            </ui:source>
            <list:colTable
