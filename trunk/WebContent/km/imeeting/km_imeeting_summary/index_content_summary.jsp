    ...
    <template:replace name="body">
        ...
        <list:listview id="listview">
            <ui:source type="AjaxJson">
                {url:'/km/imeeting/km_imeeting_summary/kmImeetingSummary.do?method=listChildren&categoryId=!{categoryId}&nodeType=!{nodeType}&q.docType=allSummary&q.j_path=%2FsummaryView'}
            </ui:source>
            <list:colTable
