...
<list:data>
    <list:data-columns var="kmImeetingSummary" list="${queryPage.list }">
        ...
        <list:data-column col="fdName" title="${ lfn:message('km-imeeting:kmImeetingSummary.fdName') }" escape="false"
                          style="text-align:left;min-width:150px;">
            <span class="com_subject">${kmImeetingSummary.fdName}</span>
        </list:data-column>
        <list:data-column headerClass="width80" col="fdHost"
                          title="${ lfn:message('km-imeeting:kmImeetingMain.fdHost') }" escape="false">
            <ui:person personId="${kmImeetingSummary.fdHost.fdId}"
                       personName="${kmImeetingSummary.fdHost.fdName}"></ui:person>
            <c:out value="${kmImeetingSummary.fdOtherHostPerson}"/>
        </list:data-column>
        <list:data-column headerClass="width140" col="fdPlace"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.fdPlace') }" escape="false">
            <c:out value="${kmImeetingSummary.fdPlace.fdName}"/>
            <c:out value="${kmImeetingSummary.fdOtherPlace}"/>
        </list:data-column>
        <list:data-column headerClass="width140" col="fdDate"
                          title="${lfn:message('km-imeeting:kmImeetingMain.fdDate') }" escape="false">
        ...
        <list:data-column headerClass="width140" col="fdHoldDate"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.fdHoldDate') }">
            <kmss:showDate value="${kmImeetingSummary.fdHoldDate}" type="datetime"/>
        </list:data-column>
        <list:data-column headerClass="width140" col="fdFinishDate"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.fdFinishDate') }">
            <kmss:showDate value="${kmImeetingSummary.fdFinishDate}" type="datetime"/>
        </list:data-column>
        <list:data-column headerClass="width80" col="docCreator.fdName"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.docCreator') }" escape="false">
            <ui:person personId="${kmImeetingSummary.docCreator.fdId}"
                       personName="${kmImeetingSummary.docCreator.fdName}"></ui:person>
        </list:data-column>
        <list:data-column headerClass="width140" col="docCreateTime"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.docCreateTime') }">
            <kmss:showDate value="${kmImeetingSummary.docCreateTime}" type="datetime"/>
        </list:data-column>
        <list:data-column headerClass="width140" col="docPublishTime"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.docPublishTime') }">
            <kmss:showDate value="${kmImeetingSummary.docPublishTime}" type="datetime"/>
        </list:data-column>
        <list:data-column headerClass="width50" col="authAttNocopy"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.authAttNocopy')}">
        ...
        <list:data-column headerClass="width50" col="authAttNoprint"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.authAttNoprint')}">
        ...
        <list:data-column headerClass="width50" col="authAttNodownload"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.authAttNodownload')}">
        ...
        <list:data-column headerClass="width50" col="docStatus"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.docStatus')}">
        ...
        <list:data-column headerClass="width40" col="fdNotifyType"
                          title="${ lfn:message('km-imeeting:kmImeetingSummary.fdNotifyType') }" escape="false">
        ...
        <list:data-column headerClass="width50" col="fdHoldDuration"
                          title="${ lfn:message('km-imeeting:kmImeetingMain.fdHoldDuration')}" escape="false">
            <%
        ...
        <list:data-column col="nodeName" escape="false"
            ...
            <kmss:showWfPropertyValues var="nodevalue" idValue="${kmImeetingSummary.fdId}" propertyName="nodeName"/>
        ...
        <list:data-column col="handlerName" escape="false"
            ...
            <kmss:showWfPropertyValues var="handlerValue" idValue="${kmImeetingSummary.fdId}"
