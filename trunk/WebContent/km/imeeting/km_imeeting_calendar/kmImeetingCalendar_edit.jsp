...
<div id="meeting_calendar_add" class="meeting_calendar_dialog"  style="position: absolute; display: none">
	...
	<div class="meeting_calendar_dialog_buttom">
		...
		<kmss:authShow roles="ROLE_KMIMEETING_CREATE">
			<!-- 会议安排 -->
			<ui:button id="meeting_add_btn" text="起草通知"  styleClass="lui_toolbar_btn_gray" onclick="meetingAdd()" />
	...
	seajs.use([
		...
		window.bookAdd=function(){
			 $('.meeting_calendar_dialog').hide();
				...
				var url="/km/imeeting/km_imeeting_book/kmImeetingBook.do?method=add&resId="+resId+"&startDate="+fdHoldDate+"&endDate="+fdFinishDate+"&source=${param.source}";
