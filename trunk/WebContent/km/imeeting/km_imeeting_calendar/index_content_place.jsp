...
<template:include ref="default.simple">
	...
	<template:replace name="body">
					...
					*/
					...
					topic.subscribe('calendar.thing.click',function(arg){
						...
						if(arg.data.type =="book"){
							...
							viewDialog.find(".fdRemark").attr("title", env.fn.formatText( textEllipsis(arg.data.fdRemark) ));//备注
						...
						viewDialog.find(".fdName").attr("title", env.fn.formatText(arg.data.title));//会议题目
						viewDialog.find(".fdPlace").html( env.fn.formatText(arg.data.fdPlaceName) );//地点
						viewDialog.find(".fdPlace").attr("title", env.fn.formatText(arg.data.fdPlaceName) );//地点
		...
		<c:import url="/km/imeeting/km_imeeting_calendar/kmImeetingCalendar_edit.jsp?showVideoEnable=false" charEncoding="UTF-8">
			<c:param name="source" value="${param.source}"></c:param>
		</c:import>
