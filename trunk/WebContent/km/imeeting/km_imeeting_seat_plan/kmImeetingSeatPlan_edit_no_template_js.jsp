...
<script>
    ...
    seajs.use(['lui/topic', 'lui/dialog', 'km/imeeting/resource/js/seatPlan',
        ...
        function (topic, dialog, SeatPlan, Seat, SeatUtil, ElementList, PersonList, TopicList) {
            ...
            // 初始化会议室元素
            var allElementData = [{type:"1",name:'座位-上',style:'status_seat_up'},
                {type:"1",name:'座位-下',style:'status_seat_down'},
                {type:"1",name:'座位-左',style:'status_seat_left'},
                {type:"1",name:'座位-右',style:'status_seat_right'},
            ...
            var elementList, hostList, participantList, summaryList, attendList, inviteList, reportersList, reporterList
