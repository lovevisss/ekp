				...
				<ui:content title="座席安排" toggle="false">
					...
					<div class="lui_seat_arrangement_wrap">
						...
						<div class="lui_seat_arrangement_aside">
							<c:if test="${kmImeetingSeatPlanForm.fdIsShowTopic == 'true' }">
								<div class="lui_seat_arrangement_aside_item">
									<div class="lui_seat_arrangement_aside_item_head">
										<h3 class="lui_seat_arrangement_aside_item_title">
											按议题排位
										</h3>
							...
							<!--主持人-->
							<div class="lui_seat_arrangement_subItem lui_seat_arrangement_item_wrapper" id="holderWrap">
						    ...
						    <!-- 出席人员 -->
							<div class="lui_seat_arrangement_subItem lui_seat_arrangement_item_wrapper" id="attendWrap">
								<div class="lui_seat_arrangement_subItem_head">
									<h4 class="lui_seat_arrangement_subItem_title">出席会议人员</h4>
									<span class="lui_seat_arrangement_subItem_opt">
							...
							<!-- 邀请人员 -->
							<div class="lui_seat_arrangement_subItem lui_seat_arrangement_item_wrapper" id="inviteWrap">
								<div class="lui_seat_arrangement_subItem_head">
									<h4 class="lui_seat_arrangement_subItem_title">邀请参加人员</h4>
									<span class="lui_seat_arrangement_subItem_opt">
										<span class="lui_seat_btn lui_seat_btn_plain" onclick="autoPlan(9);">一键排位</span>
										<span class="lui_seat_btn lui_seat_btn_plain" onclick="resetPerson(9);">重置</span>
									</span>
								</div>
								<div id="inviteTab" class="lui_seat_person_list">
								</div>
							</div>
							...
							<div class="lui_seat_arrangement_subItem lui_seat_arrangement_item_wrapper" id="participantWrap">
								<div class="lui_seat_arrangement_subItem_head">
									<h4 class="lui_seat_arrangement_subItem_title">列席会议人员</h4>
									<span class="lui_seat_arrangement_subItem_opt">
							...
							<div class="lui_seat_arrangement_subItem lui_seat_arrangement_item_wrapper" id="summaryWrap">
								<div class="lui_seat_arrangement_subItem_head">
									<h4 class="lui_seat_arrangement_subItem_title">会议纪要人员</h4>
									<span class="lui_seat_arrangement_subItem_opt">
