	...
	<template:replace name="content">
			...
			<div style="float:right">
				<div style="display: inline-block;vertical-align: middle;">
					<ui:toolbar id="toolbar">
						<kmss:auth requestURL="/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=add">
						    <ui:button text="${lfn:message('button.add')}" onclick="add();" order="1" ></ui:button>
						</kmss:auth>
						<kmss:auth requestURL="/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=deleteall&parentId=${JsParam.parentId}">
							...
							<c:import url="/sys/profile/common/change_order_num.jsp" charEncoding="UTF-8">
								<c:param name="modelName" value="com.landray.kmss.km.imeeting.model.KmImeetingSchemeTemplate"></c:param>
		...
		<list:listview>
			<ui:source type="AjaxJson">
				{url:'/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=listChildren&parentId=${JsParam.parentId}&contentType=json'}
			</ui:source>
			<list:colTable isDefault="true" layout="sys.ui.listview.columntable"
				rowHref="/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=view&fdId=!{fdId}" name="columntable">
		...
		<script type="text/javascript">
			seajs.use(['lui/jquery','lui/topic','lui/dialog','lui/toolbar'],function($,topic,dialog,toolbar){
				...
				function showButtons(parentId){
					var checkDelUrl = "/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=deleteall&parentId="+parentId;
					var data = [];
				...
				window.add = function(){
					dialog.categoryForNewFile(
							...
							'/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=add&parentId=!{id}',false,null,null,getValueByHash("docCategory"),null,null,false);
				...
				//编辑
		 		window.edit = function(id) {
			 		if(id)
		 				Com_OpenWindow('<c:url value="/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do" />?method=edit&fdId=' + id);
		 		};
				//删除
				window.deleteAll = function(id){
					...
					var url = '<c:url value="/km/imeeting/km_imeeting_scheme_template/kmImeetingSchemeTemplate.do?method=deleteall"/>';
