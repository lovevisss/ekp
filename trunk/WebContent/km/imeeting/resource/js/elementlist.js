	          	...
	          	if(self.options.mode == 'edit') {
	          		itemWrapperNode.click(function() {
	          			if($(this).hasClass('lui_seat_select')) {
							...
							$('.lui_seat_setting_wrap').removeClass('status_seat_up status_seat_down status_seat_left status_seat_right');
	    					$('.lui_seat_setting_wrap').removeClass('status_occupation status_speech');
