		...
		$router.define({
			...
			routes : [{
				...
				action : {
					...
					options : {
							...
							contents : {
								...
								'myScheme' : { title : lang['kmImeeting.tree.myHandleScheme'], route:{ path: '/drafted/myScheme' }, cri :{'myscheme':'myCreate','except':'docStatus:00','j_path':'/drafted/myScheme'}}
							}
						}
					}
				},{
					...
					action : {
						...
						options : {
							...
							contents : {
								...
								'myScheme' : { title : lang['kmImeeting.tree.myHandleScheme'], route:{ path: '/drafted/myScheme' }, cri :{'myscheme':'myCreate','except':'docStatus:00','j_path':'/drafted/myScheme'}, selected : true}
							}
						}
					}
				},{
				...
				action : function(){
					...
					createDoc(mainModelName, modelName, 'scheme','/schemeReport');
				}
			},{
				...
				path : '/kmImeeting_scheme', 
				action : {
					type : 'tabpanel',
					options : {
						panelId : 'kmImeetingPanel',
						contents : {
							'meetingScheme' : { title : lang['kmImeeting.tree.scheme'], route:{ path: '/kmImeeting_scheme' }, cri :{'j_path':'/kmImeeting_scheme'} , selected : true }
						}
					}
				}
			},{
