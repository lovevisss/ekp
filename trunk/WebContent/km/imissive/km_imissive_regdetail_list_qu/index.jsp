...
<template:include ref="default.simple" spa="true">
	<template:replace name="body">   
		<list:criteria id="regDetailListQu">
	        <list:cri-ref key="docSubject" ref="criterion.sys.docSubject"> 
			</list:cri-ref>
			<list:cri-auto modelName="com.landray.kmss.km.imissive.model.KmImissiveRegDetailListQu" property="fdStatus" multi="false" expand="true"/>
		</list:criteria>
		<div class="lui_list_operation">
			...
			<div style="float:left">
				...
				<ui:toolbar layout="sys.ui.toolbar.sort" style="float:left" >
					<list:sortgroup>
						<list:sort property="docCreateTime" text="${lfn:message('km-imissive:kmImissiveRegDetailListQu.docCreateTime')}" group="sort.list" value="down"></list:sort>
					</list:sortgroup>
				</ui:toolbar>
				</div>
			</div>
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
					{url:'/km/imissive/km_imissive_regdetail_list_qu/kmImissiveRegDetailListQu.do?method=list'}
			</ui:source>
	 	...
	 	<script type="text/javascript">
			seajs.use(['lui/jquery','lui/dialog','lui/topic','lui/toolbar'], function($, dialog , topic,toolbar) {
				window.tryReceiveFromDec = function(){
					var url = '<c:url value="/km/imissive/km_imissive_regdetail_list_qu/kmImissiveRegDetailListQu.do?method=updateTryReceiveFromDec"/>'
					var values = [];
					...
					$.ajax({     
			    	     ...
			    	     error: function(data){
							...
							dialog.failure("接收失败，失败原因请查看后台日志！");
						},
