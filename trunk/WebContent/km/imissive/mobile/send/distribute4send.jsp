...
<template:include ref="mobile.edit" compatibleMode="true">
	<template:replace name="title">
		<c:out value="${ lfn:message('km-imissive:kmImissive.distribute') }"></c:out>
	</template:replace>
		...
		<html:form action="/km/imissive/km_imissive_send_dr/kmImissiveSendDR.do">
			<div data-dojo-type="mui/view/DocScrollableView" data-dojo-mixins="mui/form/_ValidateMixin" id="scrollView">
				<div data-dojo-type="mui/panel/AccordionPanel" class="editPanel">
					<div data-dojo-type="mui/panel/Content" data-dojo-props="title:'分发',icon:'mui-ul'">
						<table class="muiSimple headTb" cellpadding="0" cellspacing="0" >
							...
							<tr id="optType" style="display: none">
								...
								<td>
									<xform:radio property="fdContentType" onValueChange="checkPdf(this.value,'${kmImissiveSendDRForm.fdMainId}','send');" showStatus="edit" mobile="true">
							...
							<tr>
								...
								<td>
									...
									<c:import url="/km/imissive/import/sysAttMain_DR_swf.jsp" charEncoding="UTF-8">
										<c:param name="showTitle" value="点聚OFD签署附件" />
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" name="fdMaintoUnitGroupIds" value="${kmImissiveSendDRForm.fdMissiveMaintoGroupIds}">
									<div id="main_m">
										<div data-dojo-type='sys/unit/mobile/selectdialog/UnitSelectDialog' id="dialog_main_m"
											 data-dojo-props='"showAllGroup":true,"afterSelect":function(evt){afterSelectMain(evt);},"idField":"fdMaintoIds","nameField":"fdMaintoNames","curIds":"${defaultFdMaintoIds}","curNames":"${defaultFdMaintoNames}","subject":"主送单位","title":"主送单位","showStatus":"edit","isMul":true,"required":false,
									   		 "listDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileAuthDataBeanService&showAll=true&parentId=!{parentId}&type=distribute",
									   		 "searchDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileSearchDataBeanService&type=distribute&fdKeyWord=!{keyword}",
									   		 ...
									   		 "fdUnitId":"${kmImissiveSendDRForm.fdUnitId}",
									   		 "decDataUrl":"/sys/common/datajson.jsp?s_bean=sysUnitMobileAuthDataWithDecBeanService&parentId=!{parentId}&type=distribute&fdUnitId=${kmImissiveSendDRForm.fdUnitId}"'>
										</div>
									</div>
								...
								<tr>
									...
									<div id="copy_m">
										<div data-dojo-type='sys/unit/mobile/selectdialog/UnitSelectDialog' id="dialog_copy_m"
											 data-dojo-props='"showAllGroup":true,"afterSelect":function(evt){afterSelectCopy(evt);},"idField":"fdCopytoIds","nameField":"fdCopytoNames","curIds":"${defaultFdCopytoIds}","curNames":"${defaultFdCopytoNames}","subject":"抄送单位","title":"抄送单位","showStatus":"edit","isMul":true,"required":false,
									   		 "listDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileAuthDataBeanService&showAll=true&parentId=!{parentId}&type=distribute",
									   		  "searchDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileSearchDataBeanService&type=distribute&fdKeyWord=!{keyword}",
									   		  "detailUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitDetailService&curIds=!{curIds}",
									   		 "headerUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitHeaderService&curId=!{curId}",
								       ...
								       <input type="hidden" name="fdMissiveReporttoGroupIds" value="${kmImissiveSendDRForm.fdMissiveReporttoGroupIds}">
										...
										<div id="report_m">
											<div data-dojo-type='sys/unit/mobile/selectdialog/UnitSelectDialog' id="dialog_report_m"
												 data-dojo-props='"showAllGroup":true,"afterSelect":function(evt){afterSelectReport(evt);},"idField":"fdReporttoIds","nameField":"fdReporttoNames","curIds":"${defaultFdReporttoIds}","curNames":"${defaultFdReporttoNames}","subject":"抄报单位","title":"抄报单位","showStatus":"edit","isMul":true,"validate":"required","required":false,
										   		 "listDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileAuthDataBeanService&showAll=true&parentId=!{parentId}&nodeType=!{nodeType}&type=distribute",
										   		  "searchDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileSearchDataBeanService&type=distribute&fdKeyWord=!{keyword}",
										   		  "detailUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitDetailService&curIds=!{curIds}",
										   		 "headerUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitHeaderService&curId=!{curId}",
										   		 "fdUnitId":"${kmImissiveSendDRForm.fdUnitId}",
								...
								<tr>
									...
									<td>
										<kmss:editNotifyType property="fdNotifyType" mobile="true" required="true"/>
									</td>
								</tr>
				...
				<ul data-dojo-type="mui/tabbar/TabBar" fixed="bottom" data-dojo-props='fill:"grid"'>
				  	<li data-dojo-type="mui/tabbar/TabBarButton" onclick="submitDistribute();"><bean:message  key="button.submit"/></li>
				</ul>
			</div>
			...
			require(["mui/dialog/BarTip", "dojo/ready"], function(BarTip, ready) {
				ready(function() {
					checkPdf('0','${kmImissiveSendDRForm.fdMainId}','send');
				}); 
			});
