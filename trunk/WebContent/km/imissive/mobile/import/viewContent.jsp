...
<%
		...
		try{
			...
			if(StringUtil.isNotNull(_modelId) 
				...
				sysAttMains = kmImissiveSendMainService.findLaTestAttMain(_modelId, _key);
			}
			if(sysAttMains!=null && sysAttMains!=null){
				pageContext.setAttribute("sysAttMain",sysAttMains);
			}
...
<%
	...
	pageContext.setAttribute("wpsCloudOfficeEnable", SysAttWpsCloudUtil.isEnable(true));
%>
<c:if test="${not empty sysAttMain}">
