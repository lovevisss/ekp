                    ...
                    <c:choose>
                        <c:when test="${not empty convertAttId and not empty convertAttType}">
                            <c:if test="${'toPDF' eq convertAttType}">
                                <kmss:auth requestURL="/sys/attachment/sys_att_main/sysAttMain.do?method=downloadPdf&fdModelName=com.landray.kmss.km.imissive.model.KmImissiveSignMain&fdId=${convertAttId}" requestMethod="GET">
                                    <li>
                            ...
                            <c:if test="${'toOFD' eq convertAttType}">
                                <kmss:auth requestURL="/sys/attachment/sys_att_main/sysAttMain.do?method=downloadOfd&fdModelName=com.landray.kmss.km.imissive.model.KmImissiveSignMain&fdId=${convertAttId}" requestMethod="GET">
                                    <li>
                                        <a onclick="Com_OpenWindow('${KMSS_Parameter_ContextPath}sys/attachment/sys_att_main/sysAttMain.do?method=download&fdId=${convertAttId}&downloadType=manual');">
                                            下载ofd
                                        </a>
