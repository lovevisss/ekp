define(["mui/util"], function(util) {
  function portletLoad(params, load) {
    ...
    var html ='<div ' +
      ...
      "data-dojo-props=\"url:'/km/imissive/km_imissive_send_main/kmImissiveSendMainPortlet.do?method=getlatest&mPortal=true&fdCategoryId=!{cateid}&rowsize=!{rowsize}&scope=!{scope}',lazy:false\">" +
      "</div>"
