define(["mui/util"], function(util) {
  function portletLoad(params, load) {
    ...
    var html ='<div ' +
      ...
      "data-dojo-props=\"url:'/km/imissive/km_imissive_sign_main/kmImissiveSignMainPortlet.do?method=getlatest&mPortal=true&fdCategoryId=!{cateid}&rowsize=!{rowsize}&scope=!{scope}',lazy:false\">" +
      "</div>"
