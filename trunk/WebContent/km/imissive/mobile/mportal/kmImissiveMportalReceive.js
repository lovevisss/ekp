define(["mui/util"], function(util) {
  function portletLoad(params, load) {
    ...
    var html ='<div ' +
      ...
      "data-dojo-props=\"url:'/km/imissive/km_imissive_receive_main/kmImissiveReceiveMainPortlet.do?method=getlatest&mPortal=true&fdCategoryId=!{cateid}&rowsize=!{rowsize}&scope=!{scope}',lazy:false\">" +
      "</div>"
