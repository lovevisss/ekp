...
define([
  ...
  "dojo/dom-construct",
  "dojo/parser",
  "sys/mportal/module/mobile/Tabbar",
  "sys/mportal/module/mobile/TabView",
  "sys/mportal/module/mobile/HashMixin",
  "dojo/_base/lang",
  "sys/mportal/module/mobile/Container",
  "sys/mportal/module/mobile/containers/Card",
  "sys/mportal/module/mobile/containers/TabsCard",
  "sys/mportal/module/mobile/elements/Button",
  "dojo/dom-class"
], function(
  declare,
  _WidgetBase,
    ...
    [_WidgetBase, _Contained, _Container, HashMixin],
    {
      ...
      parseView: function(index) {
        ...
        if (lang.isObject(contents)) {
          ...
          if (window.kmImissiveRoles) {
        	  for (var i = 0; kmImissiveRoles.length; i++) {
        		  if ('addRole' == kmImissiveRoles[i]) {
