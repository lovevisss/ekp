...
<template:include ref="mobile.edit" compatibleMode="true">
	...
	<template:replace name="content">
		<html:form action="/km/imissive/km_imissive_circulation/kmImissiveCirculation.do?method=save">
					...
					<div data-dojo-type="mui/panel/Content" data-dojo-props="title:'传阅',icon:'mui-ul'">
						...
						<table class="muiSimple headTb" cellpadding="0" cellspacing="0" >
							...
							<tr>
								...
								<br/>
								<xform:checkbox property="fdIsBusiness"  showStatus="edit" mobile="true" >
									<xform:simpleDataSource value="1">追加审批意见可阅读者</xform:simpleDataSource>
								</xform:checkbox>
								...
								<xform:checkbox property="fdNoticeMe"  showStatus="edit" mobile="true" >
									<xform:simpleDataSource value="1">提交后通知我</xform:simpleDataSource>
								</xform:checkbox>
							</td>
							</tr>
							<tr id="spreadScopeTr">
