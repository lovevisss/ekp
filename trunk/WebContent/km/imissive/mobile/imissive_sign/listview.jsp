...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/imissive/mobile/imissive_sign/js/header/IndexListNavMixin">
	</div>
	
	<%-- 搜索 --%>
	<div data-dojo-type="mui/search/SearchButtonBar"
		 data-dojo-props="modelName:'com.landray.kmss.km.imissive.model.KmImissiveSignMain'">
	</div>
</div>
...
<div data-dojo-type="mui/header/NavHeader">
	...
	<div class="muiHeaderItemRight" 
		 ...
		 data-dojo-props="modelName: 'com.landray.kmss.km.imissive.model.KmImissiveSignTemplate',catekey: 'fdTemplate',prefix:'q'"></div>	
</div>
