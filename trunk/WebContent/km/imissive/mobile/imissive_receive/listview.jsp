...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'4.4rem'" class="muiHeaderNav">
	...
	<div data-dojo-type="mui/nav/MobileCfgNavBar"
		 data-dojo-mixins="km/imissive/mobile/imissive_receive/js/header/IndexListNavMixin">
	</div>
	
	<%-- 搜索 --%>
	<div data-dojo-type="mui/search/SearchButtonBar"
		 data-dojo-props="modelName:'com.landray.kmss.km.imissive.model.KmImissiveReceiveMain'">
	</div>
</div>
...
<div data-dojo-type="mui/header/NavHeader">
    ...
    <%-- 排序（发布日期）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	    data-dojo-props="name:'docPublishTime',subject:'<bean:message bundle="km-imissive" key="mobile.kmImissive.publishDate" />',value:''">
	</div>			
    <%-- 排序（限办日期）  --%>
	<div data-dojo-type="mui/sort/SortItem" 
	...
	<div class="muiHeaderItemRight" 
		 ...
		 data-dojo-props="modelName: 'com.landray.kmss.km.imissive.model.KmImissiveReceiveTemplate',catekey: 'fdTemplate',prefix:'q'"></div>	
</div>
