...
<%@ include file="/sys/ui/jsp/common.jsp"%>
	...
	<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
		<div
			...
			data-dojo-props="defaultUrl:'/km/imissive/mobile/receive/navReceive.jsp',modelName:'com.landray.kmss.km.imissive.model.KmImissiveReceiveMain'">
		</div>
		<div data-dojo-type="mui/header/HeaderItem"
			data-dojo-mixins="mui/folder/Folder" 
			data-dojo-props="tmplURL:'/km/imissive/mobile/receive/queryReceive.jsp'">
		</div> 
	</div>
