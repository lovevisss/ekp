								...
								<td>
								    ...
								    <div id="main_m">
										<div data-dojo-type='sys/unit/mobile/selectdialog/UnitSelectDialog' id="dialog_main_m"
									    	 data-dojo-props='"showAllGroup":true,"afterSelect":function(evt){afterSelectMain(evt);},"idField":"fdMaintoIds","nameField":"fdMaintoNames","curIds":"","curNames":"","subject":"主送单位","title":"主送单位","showStatus":"edit","isMul":true,"required":false,
								...
								<tr>
									...
									<div id="copy_m">
								    	<div data-dojo-type='sys/unit/mobile/selectdialog/UnitSelectDialog' id="dialog_copy_m"
									    	 data-dojo-props='"showAllGroup":true,"afterSelect":function(evt){afterSelectCopy(evt);},"idField":"fdCopytoIds","nameField":"fdCopytoNames","curIds":"","curNames":"","subject":"抄送单位","title":"抄送单位","showStatus":"edit","isMul":true,"required":false,
									   		 "listDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileAuthDataBeanService&showAll=true&parentId=!{parentId}&type=distribute",
									   		  "searchDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileSearchDataBeanService&type=distribute&fdKeyWord=!{keyword}",
									   		  "detailUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitDetailService&curIds=!{curIds}",
									   		 "headerUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitHeaderService&curId=!{curId}"'>
								       ...
								       <input type="hidden" name="fdMissiveReporttoGroupIds" value="${kmImissiveReceiveDRForm.fdMissiveReporttoGroupIds}">
										...
										<div id="report_m">
											<div data-dojo-type='sys/unit/mobile/selectdialog/UnitSelectDialog' id="dialog_report_m"
										    	 data-dojo-props='"showAllGroup":true,"afterSelect":function(evt){afterSelectReport(evt);},"idField":"fdReporttoIds","nameField":"fdReporttoNames","curIds":"","curNames":"","subject":"抄报单位","title":"抄报单位","showStatus":"edit","isMul":true,"validate":"required","required":false,
										   		 "listDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileAuthDataBeanService&showAll=true&parentId=!{parentId}&type=distribute",
										   		  "searchDataUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitMobileSearchDataBeanService&type=distribute&fdKeyWord=!{keyword}",
										   		  "detailUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitDetailService&curIds=!{curIds}",
										   		 "headerUrl":"/sys/common/datajson.jsp?s_bean=kmImissiveUnitHeaderService&curId=!{curId}"'>
			...
			require(['dojo/ready','dijit/registry','dojo/topic','dojo/query','dojo/dom-style','dojo/dom-class',"dojo/_base/lang","mui/dialog/Tip","dojo/request","mui/device/adapter","mui/util",'dojo/date/locale'],
				function(ready,registry,topic,query,domStyle,domClass,lang,Tip,req,adapter,util,locale){
				 window.submitDistribute = function (){
					...
					if(validateFlag){
						Com_Submit(document.kmImissiveReceiveDRForm, 'updateDistribute');
					}
				}
			});	
		</script>	
