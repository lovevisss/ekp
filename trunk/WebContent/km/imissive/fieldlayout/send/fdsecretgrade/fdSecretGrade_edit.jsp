...
<%@ include file="/km/imissive/fieldlayout/common/param_parser.jsp"%>
	...
	<xform:select property="fdSecretGradeId" mobile="${param.mobile eq 'true'? 'true':'false'}" subject="${lfn:message('km-imissive:kmImissiveSendMain.fdSecretGrade')}" required="<%=required%>" style="<%=parse.getStyle()%>" showStatus="edit" value="<%=defaultValue%>">
