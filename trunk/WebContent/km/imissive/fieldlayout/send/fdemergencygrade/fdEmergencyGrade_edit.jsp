...
<div id="_fdEmergencyGrade" valField="fdEmergencyGradeId" xform_type="select">
    <xform:select property="fdEmergencyGradeId"  mobile="${param.mobile eq 'true'? 'true':'false'}" subject="${lfn:message('km-imissive:kmImissiveSendMain.fdEmergencyGrade')}" showStatus="edit" required="<%=required%>" style="<%=parse.getStyle()%>" value="<%=defaultValue%>">
