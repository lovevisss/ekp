...
<div id="div_condtionSection">
	<table class="tb_simple" width=100%>
		...
		<tr>
			<%--对象类型--%>
			<td class="td_normal_title" width=15%>
				<bean:message  bundle="km-imissive" key="kmImissiveStat.fdDeliverType"/>
			</td>
			<td width=85% colspan="3">
				<xform:checkbox property="fdDeliverType" showStatus="edit" value="${kmImissiveStatForm.fdDeliverType}">
					<xform:enumsDataSource enumsType="kmImissiveStat_fdDeliverType"></xform:enumsDataSource>
				</xform:checkbox>
			</td>
		</tr>	
		<tr>
