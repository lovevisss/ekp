...
<template:include  ref="default.simple" sidebar="no" spa="true">
	...
	<script type="text/javascript">
		...
		function loadSummaryCount(){
			$.ajax({
			     url:"${LUI_ContextPath}/km/imissive/km_imissive_receive_main/kmImissiveReceiveMain.do?method=findByStatusCount",
			     async:true,
			     dataType : 'json',
			     success:function(data){
			     	console.log(data);
			     	console.log(data.docStatus20);
		...
		function setCurrTimeVal(type){
			 var url = "/km/imissive/km_imissive_stat/kmImissiveStat.do?method=getChartByTypeReceive";
			//加载图标数据
		...
		window.onload=function(){
			if(document.body.clientWidth==0){
				var url = '${LUI_ContextPath}/km/imissive/km_imissive_stat/kmImissiveStat_countview.jsp';
	  ...
	  <ui:tabpanel layout="sys.ui.tabpanel.list">
		  <ui:content title="${lfn:message('km-imissive:tree.previewReceive') }">
			...
			<tr>
				<td colspan="4" align="center">
					...
					<div class="lui_hr_staff_panel_title">
						...
						<span class="panel_title"><bean:message key="kmImissiveStat.countview.type" bundle="km-imissive"/></span>
					</div>
					<div class="lui_hr_staff_panel_content">
						<ui:chart width="100%" height="350px" id="chart_type">
		  					<ui:source type="AjaxJson">
								{"url":"/km/imissive/km_imissive_stat/kmImissiveStat.do?method=getChartByTypeReceive&type=type"}
		  					</ui:source>
						</ui:chart>
					</div>
					</div>
				...
				<td colspan="4" align="center">
					...
					<div class="lui_hr_staff_panel_title">
						...
						<span class="panel_title"><bean:message key="kmImissiveStat.countview.num" bundle="km-imissive"/></span>
					</div>
					<div class="lui_hr_staff_panel_content">
						<ui:chart width="100%" height="350px" id="chart_num">
		  					<ui:source type="AjaxJson">
								{"url":"/km/imissive/km_imissive_stat/kmImissiveStat.do?method=getChartByTypeReceive&type=num"}
		  					</ui:source>
						</ui:chart>
					</div>
					</div>
			...
			<tr>
				<td colspan="4" align="center">
					...
					<div class="lui_hr_staff_panel_title">
						...
						<span class="panel_title"><bean:message key="kmImissiveStat.countview.emergency" bundle="km-imissive"/></span>
					</div>
						<ui:chart width="100%" height="350px" id="chart_emergency">
		  					<ui:source type="AjaxJson">
								{"url":"/km/imissive/km_imissive_stat/kmImissiveStat.do?method=getChartByTypeReceive&type=emergency"}
		  					</ui:source>
						</ui:chart>
					</div>
				</td>
				<td colspan="4" align="center">
					...
					<div class="lui_hr_staff_panel_title">
						...
						<span class="panel_title"><bean:message key="kmImissiveStat.countview.status" bundle="km-imissive"/></span>
					</div>
					<ui:chart width="100%" height="350px" id="chart_status">
	  					<ui:source type="AjaxJson">
							{"url":"/km/imissive/km_imissive_stat/kmImissiveStat.do?method=getChartByTypeReceive&type=status"}
	  					</ui:source>
					</ui:chart>
					</div>
				</td>
