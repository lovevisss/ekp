	 ...
	 <table class="tb_normal" id="toolBarDiv" width=98%>
		<tr>
			...
			<td>
			 ...
			 --%>
			<kmss:auth requestURL="/km/imissive/km_imissive_sign_main/kmImissiveReceiveMain.do?method=readViewLog&fdId=${param.fdId}" requestMethod="GET">
			<td>
				<label>
	...
	<kmss:auth requestURL="/km/imissive/km_imissive_sign_main/kmImissiveSignMain.do?method=readViewLog&fdId=${param.fdId}" requestMethod="GET">
	    ...
	    <table     width=100% style="margin-top: 20px;">
			<tr>
				<td colspan="4">
					 <c:import
						url="/km/imissive/import/sysCirculationMain_viewPrint2.jsp"
						charEncoding="UTF-8">
						<c:param
							name="formName"
							value="kmImissiveSignMainForm" />
 ...
 <script>
  function outputPDF() {
		seajs.use(['lui/jquery','lui/export/export'],function($,exp) {
			$("#toolBarDiv").hide();
			exp.exportPdf(document.getElementById('printTable'),{title:'${ kmImissiveSignMainForm.docSubject }',callback:function() {
