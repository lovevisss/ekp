...
<c:set var="kmImissiveSignMainForm" value="${requestScope[param.formName]}" />
	...
	<script type="text/javascript">
			function openfile(fdId){
				if ('${wpsoaassist}'=="true" && '${_useWpsLinuxView}'!='true' && '${xinChuangWps}' != 'true') {
				 ...
				 var url="${KMSS_Parameter_ContextPath}sys/attachment/sys_att_main/sysAttMain.do?method=view&fdModelName=com.landray.kmss.km.imissive.model.KmImissiveAttTrack&fdSendId=${kmImissiveSignMainForm.fdId}&fdId="+fdId+"&directPreview=1110110";
	  	...
	  	<list:listview id="att" channel="att">
			<ui:source type="AjaxJson">
				{"url":"/km/imissive/km_imissive_att_track/kmImissiveAttTrack.do?method=list&fdMainId=${kmImissiveSignMainForm.fdId}&fdType=7"}
			</ui:source>
