...
<%-- <ui:tabpage id="print-tab">
	<ui:content title="告知信息">
		<ui:event event="show">
			$("#print-tab .lui_tabpage_float_header_l").hide();
			$("div[data-lui-type='lui/panel!Content']").css("padding-top","0px");
		</ui:event> --%>
<form>
<center>

<%-- <div class="print_title_header" id="subjectDiv">
	<p class="lui_form_subject"><bean:write name="kmImissiveSendMainForm" property="docSubject" /></p>
</div> --%>
