...
<c:if test="${_isWpsCloudEnable ne true and _isWpsCenterEnable ne true and _useWpsLinuxView ne true  and empty restDownloadUrl and 'true' ne _useViewDowload}">
	    ...
	    <c:choose>
			 <c:when test="${isExistViewPath}">
			     <a href="javascript:void(0);" class="attswich com_btn_link"
					onclick="Com_OpenWindow('kmImissiveReceiveMain.do?method=view&fdId=${JsParam.fdId}&isShowImg=${isShowImg}&change=true','_self');">
