...
<template:include ref="default.list">
   ...
   <template:replace name="path"> 
		<ui:menu layout="sys.ui.menu.nav"  id="categoryId"> 
			...
			<ui:menu-item text="${ lfn:message('km-imissive:kmImissive.nav.ReceiveManagement') }" href="/km/imissive/km_imissive_receive_main/index.jsp" target="_self">
		...
		<div class="lui_list_nav_frame">
	      <ui:accordionpanel>
				<c:import url="/km/imissive/import/nav.jsp" charEncoding="UTF-8">
				   <c:param name="key" value="kmImissiveReceive"></c:param>
				    <c:param name="criteria" value="receiveCriteria"></c:param>
				</c:import>
				<ui:combin ref="menu.nav.favorite.category">
						<ui:varParams 
							modelName="com.landray.kmss.km.imissive.model.KmImissiveReceiveTemplate"
							onClick="LUI('receiveCriteria').setValue('fdTemplate','!{value}');resetMenuNavStyleForCate('!{value}');"/>
				</ui:combin>
	...
	<template:replace name="content">  
	   <%@ include file="/km/imissive/km_imissive_receive_main/index_content_receive.jsp"%>
	</template:replace>
</template:include>
