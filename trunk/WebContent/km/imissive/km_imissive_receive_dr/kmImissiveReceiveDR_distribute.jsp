...
$(document).ready(function(){
	...
	resetNewDialog("fdMaintoIds","fdMaintoNames",";","kmImissiveUnitListWithAuthService&newSearch=true&type=distribute",true,"","",null);
	...
	resetNewDialog("fdCopytoIds","fdCopytoNames",";","kmImissiveUnitListWithAuthService&newSearch=true&type=distribute",true,"","",null);
	...
	resetNewDialog("fdReporttoIds","fdReporttoNames",";","kmImissiveUnitListWithAuthService&newSearch=true&type=distribute",true,"","",null);
...
<table class="tb_normal" width=95% style="margin-top:20px">
	...
	<tr>
		<td class="td_normal_title" width=15%>
			...
			<input type="hidden" name="fdMaintoUnitGroupIds" value="">
		...
		<tr>
			...
			<input type="hidden" name="fdCopytoUnitGroupIds" value="">
		...
		<tr>
			<td class="td_normal_title" width=15%>
		       ...
		       <input type="hidden" name="fdMissiveReporttoGroupIds" value="">
				<input type="hidden" name="fdReporttoUnitGroupIds" value="">
