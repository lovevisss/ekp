...
<c:if test="${compressSwitch eq 'true'}">
    <%
        ...
        list.add("sys/ui/js/menu.js");
        list.add("sys/ui/js/spa/adapters/menuSourceAdapter.js");
        list.add("sys/ui/js/popup.js");
        list.add("sys/ui/js/spa/adapters/menuItemAdapter.js");
        list.add("sys/ui/js/spa/adapters/menuAdapter.js");
        ...
        if ("send".equals(fdType)) {
            minJsSrc += "imissive_receive_flatContent_gkp_min.js";
        } else {
            minJsSrc += "imissive_" + fdType + "_flatContent_gkp_min.js";
        }
