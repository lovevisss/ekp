		...
		<td>
			<table class="tb_normal" width=100%>
               ...
               <tr>
				...
				<tr>
					<td class="td_normal_title" width=15%>
						<bean:message bundle="km-imissive" key="kmImissiveRedHeadTemplate.parentMaintainer" />
					</td><td colspan="3" id="parentMaintainerId">
						${parentMaintainer}
					</td>					 
				</tr>
				<%---更改父类时同时修改继承上级分类维护者---%>
				<script>
					...
					function Cate_getParentMaintainer(){				
						...
						var s_url = Com_Parameter.ContextPath+"km/imissive/km_imissive_redhead_template/kmImissiveRedHeadTemplate.do?method=getParentMaintainer";
						$.ajax({
							url: s_url,
							type: "GET",
							data: parameters,
                ...
                <c:import url="/sys/authorization/sys_auth_area/sysAuthArea_field.jsp" charEncoding="UTF-8">
                    <c:param name="id" value="${kmImissiveRedHeadTemplateForm.authAreaId}"/>
                </c:import> 
				<tr>
					<td class="td_normal_title" width=15%>
				...
				<tr>
	            	<td width="15%" class="td_normal_title" valign="top">
	                	...
	                	<xform:textarea property="fdDesc" style="width:90%;height:90px" />
	            	</td>
                </tr>
				<tr>
					<td class="td_normal_title" width=15%>
						...
						<bean:write name="kmImissiveRedHeadTemplateForm" property="docCreatorName"/>
					</td>
					<td class="td_normal_title" width=15%>
						<bean:message key="model.fdCreateTime" />
					</td><td width=35%>
						<bean:write name="kmImissiveRedHeadTemplateForm" property="docCreateTime"/>
					</td>			
				</tr>
				<c:if test="${kmImissiveRedHeadTemplateForm.docAlterorName!=''}">
					<tr>
						<td class="td_normal_title" width=15%>
							...
							<bean:write name="kmImissiveRedHeadTemplateForm" property="docAlterorName"/>
						</td>
						<td class="td_normal_title" width=15%>
							<bean:message key="model.fdAlterTime" />
						</td><td width=35%>
							<bean:write name="kmImissiveRedHeadTemplateForm" property="docAlterTime"/>
						</td>
					</tr>
				</c:if>
			</table>
				 ...
				 <tr>
				    ...
				    <td>
				       ...
				       <div id="categoryDesc" style="display:none">
				       	<bean:message key="kmImissiveRedHeadTemplate.categoryDesc" bundle="km-imissive"/>
				       </div>
				    </td>
				  </tr>
				  <tr>
				     ...
				     <div id="wordEdit" style="height:600px;">
						...
						<div>
							<c:choose>
								...
								<c:choose>
									<c:when test="${kmImissiveRedHeadTemplateForm.method_GET=='edit'}">
										<div id="wpsImissive">
									...
									<c:otherwise>
										...
										<c:import url="/sys/attachment/sys_att_main/sysAttMain_edit.jsp" charEncoding="UTF-8">
													...
													<c:param name="fdModelId" value="${kmImissiveRedHeadTemplateForm.fdId }" />
													<c:param name="fdModelName" value="com.landray.kmss.km.imissive.model.KmImissiveRedHeadTemplate" />
													<c:param name="formBeanName" value="kmImissiveRedHeadTemplateForm" />
