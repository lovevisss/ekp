	  ...
	  <list:criteria id="sendCriteria" cfg-canExpand="false">
		...
		<list:listview id="listview_send">
			<ui:source type="AjaxJson">
					{url:'/km/imissive/km_imissive_send_main/kmImissiveSendMainDataOther.do?method=listChildren&categoryId=${JsParam.categoryId}&modelName=${JsParam.fdModelName}&q.j_path=%2FsummaryView&hasDisCard=true'}
			</ui:source>
