	  ...
	  <list:criteria id="sendCriteria" cfg-canExpand="false">
		...
		<list:listview id="listview_send">
			<ui:source type="AjaxJson">
					{url:'/km/imissive/km_imissive_send_main/kmImissiveSendMainDataOther.do?method=listChildren&categoryId=${JsParam.categoryId}&q.fdModelName=${param.fdModelName}&&q.docType=myDraft&q.j_path=%2FsummaryDraft&hasDisCard=true'}
			</ui:source>
	 	...
	 	<!-- <script type="text/javascript">
	 		window.onload = function() {
		 		...
		 		if (fdModelName) {
		 			fdUrl = "";
		 			LUI("listview_send").source.setUrl(fdUrl + "&fdModelName=" + fdModelName);
					LUI("listview_send").source.get();
		 		}
	 		}
	 	</script> -->
	</template:replace>	 
