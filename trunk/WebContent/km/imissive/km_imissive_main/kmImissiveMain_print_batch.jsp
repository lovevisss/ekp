...
<form name="kmImissiveSendMainFormTemp" method="post" action="<c:url value="/km/imissive/km_imissive_send_main/kmImissiveSendMain.do"/>">
<c:forEach items="${kmSendFormList }" var="kmImissiveSendMainFormTemp" varStatus="vstatus">
<kmss:auth requestURL="/km/imissive/km_imissive_send_main/kmImissiveSendMain.do?method=view&fdId=${kmImissiveSendMainFormTemp.fdId}" requestMethod="GET">
<c:set var="kmImissiveSendMainForm" value="${kmImissiveSendMainFormTemp }" scope="request" />
<div class="print_title_header">
<p id="title" class="print_txttitle"><bean:write name="kmImissiveSendMainForm" property="docSubject" /></p>
<div class="printDate">
...
<div>
   <div class="tr_label_title">
	...
	<%-- <c:if test="${kmImissiveSendMainFormTemp.fdUseForm == 'true' || empty kmImissiveSendMainFormTemp.fdUseForm}"> --%>
	...
	<%-- <c:if test="${kmImissiveSendMainFormTemp.fdUseForm == 'false'}"> --%>
...
<div class="lui_form_content_frame" style="padding-top:10px" id="wflogDiv_${vstatus.index }">
		...
		<div class="lui_form_content_frame" style="padding-top:10px" id="relationDiv_${vstatus.index }">
		...
		<div class="lui_form_content_frame" style="padding-top:10px" id="disandrepDiv_${vstatus.index }">
...
<% 
	...
	//清除表单信息
	request.removeAttribute("kmImissiveSendMainForm"); 
%> 
</kmss:auth>
</c:forEach>
</form>
<form name="kmImissiveReceiveMainFormTemp" method="post" action="<c:url value="/km/imissive/km_imissive_receive_main/kmImissiveReceiveMain.do"/>">
<c:forEach items="${kmReceiveFormList }" var="kmImissiveReceiveMainFormTemp" varStatus="vstatus">
<kmss:auth requestURL="/km/imissive/km_imissive_receive_main/kmImissiveReceiveMain.do?method=view&fdId=${kmImissiveReceiveMainFormTemp.fdId}" requestMethod="GET">
<c:set var="kmImissiveReceiveMainForm" value="${kmImissiveReceiveMainFormTemp }" scope="request" />
<div class="print_title_header">
<p id="title" class="print_txttitle"><bean:write name="kmImissiveReceiveMainForm" property="docSubject" /></p>
<div class="printDate">
  <bean:message bundle="km-imissive" key="kmImissive.fdPrintDate" />:<% out.print(DateUtil.convertDateToString(new Date(), DateUtil.TYPE_DATE, request.getLocale()));%>
</div>
</div>
	...
	<div class="lui_form_content_frame" style="padding-top:10px">
			...
			<tr>
				<td colspan="4">
					...
					<c:import url="/sys/xform/include/sysForm_view.jsp" charEncoding="UTF-8">
						...
						<c:param name="fdId" value="${kmImissiveReceiveMainForm.fdId }"/>
						<c:param name="messageKey" value="km-imissive:kmImissiveSendMain.baseinfo"/>
						<c:param name="useTab" value="false"/>
						<c:param name="isPrint" value="true" />
					</c:import>
	    ...
	    <table     width=100% style="margin-top: 20px;">
			<tr>
				<td colspan="4">
					<c:choose>
					  <c:when test="${not empty kmImissiveReceiveMainForm.attachmentForms['attachment'].attachments}">
						   <c:import url="/sys/attachment/sys_att_main/sysAttMain_view.jsp" charEncoding="UTF-8">
								<c:param
									name="fdKey"
									value="attachment" />
...
<% 
	...
	request.removeAttribute("com.landray.kmss.sys.xform.MulitiLang");
	//清除表单信息
	request.removeAttribute("kmImissiveReceiveMainForm"); 
%> 
</kmss:auth>
</c:forEach>
</form>
