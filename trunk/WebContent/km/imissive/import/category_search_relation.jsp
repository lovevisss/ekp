									...
									<li class="lui-cate-simple-panel-list-item">
										 <div class="link-box">
											...
											<div class="link-box-body">
												<a class="btn-add" href="javascript:;" onclick="javascript:openCreate('{%_data[i].value%}&fdModelName=${param.fdModelName}&isRelationFile=1');" title="{%env.fn.formatText(_data[i].text)%}"><bean:message key="button.add" /></a>
											</div>
										</div>
									</li>
								$}
