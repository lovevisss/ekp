...
<template:include ref="default.simple" spa="true" rwd="true">
  ...
  <list:criteria id="regCriteria" multi="false" cfg-canExpand="false">
	...
	<list:listview id="listview_reg_report"  >
		<ui:source type="AjaxJson">
				{url:'/km/imissive/km_imissive_reg/kmImissiveReg.do?method=list&q.fdDeliverType=2&q.j_path=${JsParam.path}&q.fdRegType=${JsParam.fdRegType}'}
		</ui:source>
 	...
 	seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($, dialog , topic) {
			...
			window.doSearchAction = function(evt){
				...
				var j_path_value = "/exchange/myreport";
				var obj2 = {};
				var values2 = [];
