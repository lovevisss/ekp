...
<list:data>
	<list:data-columns var="kmImissiveSendMain" list="${queryPage.list }">
		...
		<list:data-column headerClass="width120" escape="false" col="fdDocNum" title="${ lfn:message('km-imissive:kmImissiveSendMain.fdDocNum')}">
		...
		<list:data-column headerClass="width80"  col="fdDraftDept.fdName" title="${ lfn:message('km-imissive:kmImissiveSendMain.fdDraftDeptId')}" escape="false">
			<c:if test="${kmImissiveSendMain.fdDraftDept != null}">
				<c:out value="${kmImissiveSendMain.fdDraftDept.fdName}"/>
			</c:if>
		</list:data-column>
