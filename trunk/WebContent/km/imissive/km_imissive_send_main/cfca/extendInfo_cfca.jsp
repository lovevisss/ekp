...
<div align="left">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<font size="3">签章名称：1</font>
	<xform:text property="fdSigner" showStatus="readOnly" required="true" value="" style="width:5%"/>
	<input type="hidden" name="fdMainId" value="${kmImissiveSendMain.fdId}"/>
...
<kmss:auth requestURL="/km/imissive/km_imissive_out_sign/kmImissiveOutSign.do?method=sign&signKey=send">
