...
<!-- 阅读机制 -->
	<c:import url="/sys/readlog/import/sysReadLog_view.jsp" charEncoding="UTF-8">
		...
		<c:param name="isTab" value="true" />
	</c:import>
	<!-- 阅读机制 -->
	<tr LKS_LabelName="${ lfn:message('km-imissive:kmImissiveSendMain.tracking.record') }">
		<td KMSS_OnShow="window.loadPublishData && loadPublishData();$(this).removeAttr('KMSS_OnShow')">
		 ...
		 topic.channel("report").subscribe("list.loaded",ddd);
		     ...
		     <div id ="trackArea">
				...
				<table width=100% class="tb_normal">
					  ...
					  <!--分发记录 -->
					  <c:if test="${mainForm.docStatus =='30' && mainForm.fdMissiveType != '2'}">
	...
	<!-- 权限机制-->
   <tr LKS_LabelName="${ lfn:message('sys-right:right.moduleName') }">
	   	<td>
